...
#2. 编码器设计
#2.2 Transformer分⽀（PVTv2-B2）

#2.2 采⽤⾦字塔视觉Transformer结构
#2.2 输出四个层级的特征图，分辨率同样为1/4、1/8、1/16、1/32; 通道数分别为64、128、320、512
#2.2 使⽤PVTv2在ImageNet上的预训练权重初始化
...
class PVTV2B2(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, embed_dims=[64, 128, 320, 512],
                 ...
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], pretrained_path=None):
        super().__init__()
    ...
    def load_pretrained(self, pretrained_path):
        try:
            ...
            print(f"Loaded PVTv2-B2 pretrained weights from {pretrained_path}")
...
def pvt_v2_b2(pretrained_path=None, **kwargs):
    model = PVTV2B2(
